...
using spike_azure_active_directory.Utils;

namespace spike_azure_active_directory.Extensions
{
    public static class AzureAdAuthenticationBuilderExtensions
    {
        ...
        private class ConfigureAzureOptions : IConfigureNamedOptions<OpenIdConnectOptions>// IConfigureNamedOptions<JwtBearerOptions>
        {
            ...
            public void Configure(string name, OpenIdConnectOptions options) //JwtBearerOptions options)
            {
            ...
            /// </summary>
            private Task OnAuthenticationFailed(Microsoft.AspNetCore.Authentication.OpenIdConnect.AuthenticationFailedContext context)
            {
